        ...
        <nav class="navbar navbar-expand-md bg-dark navbar-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="nav navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="?page=home">Home<i class="fa fa-home"></i></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?page=about">About<i class="fa fa-address-card"></i></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="?page=contact">Contact<i class="fa fa-envelope"></i></a>
                    </li>
                </ul>
            </div>
        </nav>
